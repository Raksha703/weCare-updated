...
declare global {
  interface Window {
    google: any; // You can specify a more specific type if needed
  }
}
  ...
  useEffect(() => {
    const setMap = async () => {
      const loader = new Loader({
        ...
        version: "weekly",
        libraries: ["places"], // You can include additional libraries as needed
      });
      ...
      const map = new google.maps.Map(
        document.getElementById("room-map") as HTMLElement,
        mapOptions
      );
